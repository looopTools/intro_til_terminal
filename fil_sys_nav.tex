...
Hvis man ønsker at slette en mappe og alt der ligger i mappen, skal man sætte følgende flag på \textit{rm -r}, hvor \texit{-r} står for rekrusiv. Hvilket vil sige at den udføre kommandoen rekrusivt.
\begin{lstlisting}
	h271:test tools$ ls
        t_1	t_2	test_2
